 ...
 * 	인터냇에서 웹 페이지, 이미지, 동영상 등과 같은 리소스를 찾을 수 있는 주소
 * 
 * 
 * https://n.news.naver.com:443/article/020/0003493846?ntype=RANKING
 * 	
 * 프로토콜(protocol) (https://)
 * 	컴퓨터 네트워크를 통해 통신을 수행하기 위한 표준 규칙, 절차, 혹은 통신 스로세스를 의미
 * 	ex) https/http - 웹서버 프로토콜
 *		ftp - 파일서버 프로토콜
 *		mailto - 전자메일 서버 프로토콜
 *		telnet - 원격지 접속 프로토콜
 *
 ...
 * 	ex) 80(http (default)) 443(https (default)) (숨겨져있음!!!)
 * 
 * 
 * 경로(path)
 * 	웹 서버에서 자원에 대한 경로(무리적 또는 추상적 경로)
 * 	ex) article/020/0003493846
 * 	/경로1/경로2/페이지이름.html (보안때문에 이렇게는 잘 안씀)
...
public class MainClass02 {
	public static void main(String[] args) throws MalformedURLException {
		URL url = new URL("https://n.news.naver.com:443/article/020/0003493846?ntype=RANKING");

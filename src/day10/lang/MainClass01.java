 ...
 * [[ Object 클래스 ]]
 * 	모든 클래스의 최상위 부모이다.
 * 	즉 모든 클래스는 Object 클래스를 상속 받는다. (기본적으로 상속받고 있음)
 * 	extends 생략!!
 * 
...
public class MainClass01 {
	public static void main(String[] args) {
		...
		// 기본형 변수 immutable 불변의 변수 -> 메모리 값이 변경되지 않음 
		int num1 = 10;
		int num2 = 10;
	    ...
	    // String은 기본형이 아님에도 immutable 특성을 가진다.
		String str = "hello";
		...
		String str3 = new String("hello"); // new 연산자를 사용하면 immutable 특성을 가지 않는다. 

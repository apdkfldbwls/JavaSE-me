...
//			System.out.println(num2);	// 초기화 X 컴파일에러 발생!!
			...
			MainClass01 m1 = new MainClass01(); // 전역변수에 있는 것 생성 
			...
			System.out.println(Card.width);   // 객체생성(Card card = new~)을 해주지 않아도 클래스명으로 선언가능 
			System.out.println(Card.heigth);  // 클래스명 = Card(대문자 C)
